            ...
            <div class="order-health-container">
              ...
              <div class="order-health-chart">
                ...
                <div class="donut-legend-compact">
                  <div class="legend-item-compact"><span class="legend-dot" style="background: var(--color-accent)"></span>{{ t('status.delivered') }}</div>
...
export default {
  ...
  setup() {
    ...
    const categoryData = computed(() => {
      ...
      const singleColor = 'var(--color-primary)' // Brand primary color for category bars
